...
define([
    ...
    return Component.extend({
        defaults: {
            template: 'Webkul_MpZipCodeValidator/shipping',
        ...
        setCustomMessage: function () {
            ...
            var quickOrder  = window.location.pathname.split('/'); //fix quickOrder issue
            var baseurl = url + pathname[0];
            var productId = [];
            if (quickOrder.indexOf("quickOrder") > -1) {
                baseurl = url +'/'+ quickOrder[1];
            }
            var i;
            ...
            var messageAjax = $.ajax({
                url : baseurl +"/mpzipcodevalidator/zipcode/shippingresult",
                data : {
