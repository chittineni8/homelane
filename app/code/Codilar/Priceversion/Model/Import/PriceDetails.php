<?php
namespace Codilar\Priceversion\Model\Import;
...
class PriceDetails extends \Magento\ImportExport\Model\Import\Entity\AbstractEntity
{

    const ENTITY_CODE = 'codilar_priceversion_priceversiondetails';
    const TABLE = 'codilar_priceversion_priceversiondetails';
    const ENTITY_ID_COLUMN = 'priceversiondetails_id';
    const ID = 'priceversiondetails_id';
    const PRICEVERSIONID = 'price_version_id';
    const SKU = 'sku';
    const PRICE = 'price';
    const ADDPRICE = 'add_price';
    const MULTI = 'multi';
    const MINORDERQTY = 'min_order_qty';
    const MINORDERVALUE = 'min_order_value';
    const STATUS = 'status';

    const TABLE_ENTITY = 'codilar_priceversion_priceversiondetails';
