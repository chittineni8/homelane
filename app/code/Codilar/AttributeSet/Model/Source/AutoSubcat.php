...
class AutoSubcat implements OptionSourceInterface
{
    ...
    const AUTO_SUBCAT_URI = 'codilar_erp_attributeset/automat_subcat_erp_oauth/automat_subcat_request_url';
    const AUTO_SUBCAT_ENDPOINT = 'codilar_erp_attributeset/automat_subcat_erp_oauth/automat_subcat_endpoint';
    const AUTO_SUBCAT_TOKEN = 'codilar_erp_attributeset/automat_subcat_erp_oauth/automat_subcat_token';
