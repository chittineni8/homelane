...
namespace Codilar\Nwdthemes\Model\Revslider\Admin\Includes;
	...
	public function write_header_html(){
		...
		<head>
			...
			if($this->export_real){
				...
				<link href="http://fonts.googleapis.com/css?family=Roboto%3A700%2C300&display=swap" rel="stylesheet" property="stylesheet" type="text/css" media="all" />
