...
namespace Codilar\Nwdthemes\Model\Revslider\Admin;
...
class RevSliderAdmin extends RevSliderFunctionsAdmin {
	...
	public function enqueue_admin_styles(){
		FA::wp_enqueue_style('rs-open-sans', '//fonts.googleapis.com/css?family=Open+Sans:400,300,700,600,800&display=swap');
        FA::wp_enqueue_style('rs-roboto', '//fonts.googleapis.com/css?family=Roboto&display=swap');
        FA::wp_enqueue_style('tp-material-icons', '//fonts.googleapis.com/icon?family=Material+Icons&display=swap');
