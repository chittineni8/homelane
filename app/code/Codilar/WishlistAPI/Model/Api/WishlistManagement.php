                ...
                if (!empty($collection->getData())):
                    ...
                    foreach ($collection as $item) {
                        ...
                        $data = [
                            ...
                            'room_type' => $this->_productRepository->getById($item->getProductId())->getAttributeText('room_type'),
                            'category_type' => $this->_productRepository->getById($item->getProductId())->getAttributeText('category_type'),
