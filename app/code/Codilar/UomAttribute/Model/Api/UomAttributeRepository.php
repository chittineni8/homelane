...
namespace Codilar\UomAttribute\Model\Api;

use Exception;
use Codilar\UomAttribute\Api\UomAttributeRepositoryInterface;
use Codilar\UomAttribute\Model\UomAttribute as Model;
use Codilar\UomAttribute\Model\UomAttributeFactory as ModelFactory;
use Codilar\UomAttribute\Model\ResourceModel\UomAttribute as ResourceModel;
use Magento\Framework\Exception\AlreadyExistsException;
use Codilar\UomAttribute\Model\ResourceModel\UomAttribute\Collection;
use Codilar\UomAttribute\Model\ResourceModel\UomAttribute\CollectionFactory;


class UomAttributeRepository implements UomAttributeRepositoryInterface
{
    /**
     * @var ModelFactory
     */
