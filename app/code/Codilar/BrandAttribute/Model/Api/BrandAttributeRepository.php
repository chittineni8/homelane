...
namespace Codilar\BrandAttribute\Model\Api;

use Exception;
use Codilar\BrandAttribute\Api\BrandAttributeRepositoryInterface;
use Codilar\BrandAttribute\Model\BrandAttribute as Model;
use Codilar\BrandAttribute\Model\BrandAttributeFactory as ModelFactory;
use Codilar\BrandAttribute\Model\ResourceModel\BrandAttribute as ResourceModel;
use Magento\Framework\Exception\AlreadyExistsException;
use Codilar\BrandAttribute\Model\ResourceModel\BrandAttribute\Collection;
use Codilar\BrandAttribute\Model\ResourceModel\BrandAttribute\CollectionFactory;


class BrandAttributeRepository implements BrandAttributeRepositoryInterface
{
    /**
     * @var ModelFactory
     */
