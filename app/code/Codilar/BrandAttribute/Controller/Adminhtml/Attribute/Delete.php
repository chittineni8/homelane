...
class Delete implements ActionInterface
{
    ...
    public function execute()
    {
        ...
        $redirectResponse->setUrl($this->url->getUrl('brandattribute/attribute/index'));
        $result = $this->brandattributeRepository->deleteById($this->request->getParam('id'));
        if ($result) {
            $this->manager->addSuccessMessage(
                __(sprintf(
                        'The  Attribute with id %s has been deleted Successfully',
