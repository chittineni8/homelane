        ...
        try {
            ...
            if ($status == 200) {
                ...
                if ($otpstatus == 200):
                    ...
                    $this->loggerResponse->addInfo('=====================OTP GENERATE API SUCCESS=============');
                    $this->loggerResponse->addInfo('OTP Generated for Email:' . $email);
                    $this->loggerResponse->addInfo('=========================================================');
                elseif ($otpstatus == 400):

                    $this->loggerResponse->addInfo('======================OTP GENERATE API ERROR==============');
                    $this->loggerResponse->addInfo('Phone number is missing');
                    $this->loggerResponse->addInfo('=========================================================');
            ...
            $this->loggerResponse->critical($e->getMessage() . ' ' . 'REGISTER API EXCEPTION');
        }//end try
