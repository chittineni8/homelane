<?php
namespace Codilar\Vendor\Model\Import;
...
class Vendor extends \Magento\ImportExport\Model\Import\Entity\AbstractEntity
{

    const ENTITY_CODE = 'codilar_vendor_vendor';
    const TABLE = 'codilar_vendor_vendor';
    const ENTITY_ID_COLUMN = 'vendor_id';
    const AUTOMATVENDORID = 'automat_vendor_id';
    const AUTOMATVENDORNAME = 'automat_vendor_name';
    const SAPVENDORID = 'sap_vendor_id';
    const SAPVENDORNAME = 'sap_vendor_name';
    const CITY = 'city';
    const LEADTIME = 'lead_time';
    const BUYINGPRICE = 'buying_price';
    const SKU = 'sku';
    const VEDNORSKU = 'vendor_sku';
    const VENDORSKUSTATUS = 'vendor_sku_status';

    const TABLE_ENTITY = 'codilar_vendor_vendor';
    ...
    */
    ...
    public function validateRow(array $rowData, $rowNum): bool
    {
        ...
        $product = $this->productRepository->get($name);
          ...
          if($product->getId()){
            $this->addRowError('SKU Is Not Available', $rowNum);
          }
    ...
    private function initMessageTemplates()
    {
        ...
        $this->addMessageTemplate(
            'Price Verison Is Required',
            __('The Price Verison cannot be empty.')
        );
    }
