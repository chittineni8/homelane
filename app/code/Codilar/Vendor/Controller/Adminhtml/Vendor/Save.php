...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create(\Codilar\Vendor\Model\Vendor::class)->load($id);
            if (!$model->getId() && $id) {
            ...
            try {
                ...
                $this->dataPersistor->clear('codilar_vendor_vendor');
            ...
            $this->dataPersistor->set('codilar_vendor_vendor', $data);
